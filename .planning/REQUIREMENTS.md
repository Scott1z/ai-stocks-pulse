...
- [x] **BACK-01**: A VAPID key pair exists — public key embedded client-side, private key stored as a Vercel environment variable
- [x] **BACK-02**: Push subscriptions are stored in Redis via the Upstash for Redis integration (Vercel Marketplace)
